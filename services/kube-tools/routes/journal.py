...
from services.journal_service import CreateJournalCategoryRequest, CreateJournalEntryRequest, CreateJournalUnitRequest, JournalService, UpdateJournalCategoryRequest, UpdateJournalEntryRequest, UpdateJournalUnitRequest
...
async def get_unites(container):
    service: JournalService = container.resolve(JournalService)
